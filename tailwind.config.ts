  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "security-gradient": "linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%)",
        "emerald-gradient": "linear-gradient(135deg, #059669 0%, #10b981 100%)",
        "slate-gradient": "linear-gradient(135deg, #475569 0%, #64748b 100%)",
      },
      boxShadow: {
        "security": "0 4px 20px -2px rgba(59, 130, 246, 0.15)",
        "emerald": "0 4px 20px -2px rgba(5, 150, 105, 0.15)",
        "slate": "0 4px 20px -2px rgba(71, 85, 105, 0.15)",
      },
      spacing: {
        "18": "4.5rem",
        "88": "22rem",
